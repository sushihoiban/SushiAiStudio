                ...
                filteredBookings.map((booking) => {
                  ...
                  return (
                    <tr key={booking.group_id} className="hover:bg-dark-700/30 transition-colors group">
                      <td className="p-4 pl-6"><div className="text-neutral-100 font-medium">{booking.customer_name === 'Unknown' ? t('common.unknown') : booking.customer_name}</div><div className="text-xs text-neutral-500 font-mono mt-0.5">{booking.phone}</div></td>
